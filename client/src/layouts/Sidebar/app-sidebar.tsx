...
import { NavDocuments } from "@/layouts/Sidebar/nav-documents"
...
import {getUserFromLocalStorage} from "@/utills/helper/getUser"
...
const data = {
 ...
 name:
      ...
      (getGoogleUser && getGoogleUser.displayName) ||
      "User", 
    email:    UserData && UserData.email || getGoogleUser && getGoogleUser.email ||  "m@example.com",
    avatar:  getGoogleUser && getGoogleUser.photoURL ||   avatar,
  },
  navMain: [
    {
      title: "Dashboard",
